...
Found a bug, have a question, or want to suggest an improvement? Please [open an issue](https://github.com/oreguchi/vb-winforms-skills/issues).
...
不具合の報告、質問、改善提案などは [Issue](https://github.com/oreguchi/vb-winforms-skills/issues) からお願いします。
